...
withDefaults(defineProps<{ home?: boolean }>(), {
  home: false,
});
</script>
<template>
      ...
      <div class="container">
        <div class="relative flex items-center justify-between -mx-4">
          <div class="max-w-full px-4 w-60">
            <NuxtLink v-if="home" to="/" class="navbar-logo block w-full py-5">
              <img
            ...
            <NuxtLink v-else to="/" class="navbar-logo block w-full py-5">
              <img
            ...
            <div>
              ...
              >
                <span
                  ...
                  :class="{ 'bg-white': home, 'bg-dark dark:bg-white': !home }"
                ></span>
                <span
                  class="relative my-[6px] block h-[2px] w-[30px]"
                  :class="{ 'bg-white': home, 'bg-dark dark:bg-white': !home }"
              ...
              >
                <ul class="blcok lg:flex 2xl:ml-20">
                  <li class="group relative">
                    <a
                      href="#home"
                      class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6"
                      :class="{
                        'lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70': home,
                        'lg:text-body-color dark:lg:text-dark-6': !home,
                      }"
                    >
                      Home
                    </a>
                  ...
                  <li class="group relative">
                    <a
                      href="#about"
                      class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-7 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 xl:ml-10"
                      :class="{
                        'lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70': home,
                        'lg:text-body-color dark:lg:text-dark-6': !home,
                      }"                  
                  ...
                  <li class="submenu-item group relative">
                    <a
                      ...
                      class="relative flex items-center justify-between py-2 mx-8 text-base font-medium group-hover:text-primary lg:ml-8 lg:mr-0 lg:inline-flex lg:py-6 lg:pl-0 lg:pr-4 xl:ml-10"
                      :class="{
                        'text-dark dark:text-white lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70': home,
                        'text-primary': !home,
                      }"
                    >
                      Pages
            ...
            <div class="flex items-center justify-end pr-16 lg:pr-0">
              ...
              >
                <input
                  ...
                  class="sr-only"
                />
                <span class="block dark:hidden" :class="{ 'text-white': home, 'text-dark dark:text-white': !home }">
                  <svg
                    class="fill-current"
                    width="24"
                    height="24"
                ...
                <span class="hidden dark:block" :class="{ 'text-white': home, 'text-dark dark:text-white': !home }">
                  <svg
                    class="fill-current"
                    width="24"
                    height="24"
              ...
              <div class="hidden sm:flex">
                <NuxtLink
                  ...
                  :class="{ 'text-white': home, 'text-dark dark:text-white': !home }"
                >
                  Sign In
                </NuxtLink>
                <NuxtLink
                  to="signup"
                  class="signUpBtn rounded-md px-6 py-2 text-base font-medium text-white duration-300 ease-in-out"
                  :class="{ 'bg-white bg-opacity-20 hover:bg-opacity-100 hover:text-dark': home, 'bg-primary hover:bg-blue-dark': !home }"
                >
                  Sign Up
                </NuxtLink>
              </div>
